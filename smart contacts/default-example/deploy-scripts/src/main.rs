...
async fn main() -> Result<(), Error> {
    ...
    use default_example::CustomInputParameter; // Example

    let param = OwnedParameter::from_serial(&CustomInputParameter { num: 42 })?; // Example

    let init_method_name: &str = "init_default_example"; // Example
    ...
    let update_payload = transactions::UpdateContractPayload {
        ...
        receive_name: OwnedReceiveName::new_unchecked("default_example.receive".to_string()),
